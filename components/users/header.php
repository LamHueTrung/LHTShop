                    ...
                    <div class="row h-100 align-items-center justify-content-center">
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="top_single_area d-flex align-items-center">
                                <!-- Logo Area -->
                                <div class="top_logo" style="margin-top: 10px;">
                                    <a href="#"><img width="100%" height="150" src="./img/img-user/core-img/logo-2.jpg" alt=""></a>
                                    <!-- <?php echo _DIR_['IMG']['USERS'].'core-img/'.'logo-2.jpg';?> -->
                                </div>
                            </div>
                        </div>
